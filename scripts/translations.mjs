...
export const translations = {
  en: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting is live on the Apple App Store. Google Play remains in progress.",
      appleStoreBody: "Scan the QR code or open the localized App Store page.",
      appleStoreAction: "Open on the App Store →",
      appleQrAlt: "NoBS Fasting App Store QR code",
  ...
  es: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting ya está disponible en Apple App Store. Google Play sigue en desarrollo.",
      appleStoreBody: "Escanea el código QR o abre la página localizada de App Store.",
      appleStoreAction: "Abrir en App Store →",
      appleQrAlt: "Código QR de NoBS Fasting en App Store",
  ...
  pt: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting já está disponível na Apple App Store. Google Play continua em desenvolvimento.",
      appleStoreBody: "Escaneie o código QR ou abra a página localizada da App Store.",
      appleStoreAction: "Abrir na App Store →",
      appleQrAlt: "Código QR do NoBS Fasting na App Store",
  ...
  fr: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting est disponible sur l'Apple App Store. Google Play reste en cours de préparation.",
      appleStoreBody: "Scannez le code QR ou ouvrez la page App Store localisée.",
      appleStoreAction: "Ouvrir dans l'App Store →",
      appleQrAlt: "Code QR App Store de NoBS Fasting",
  ...
  de: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting ist im Apple App Store verfügbar. Google Play ist weiterhin in Arbeit.",
      appleStoreBody: "Scanne den QR-Code oder öffne die lokalisierte App Store-Seite.",
      appleStoreAction: "Im App Store öffnen →",
      appleQrAlt: "NoBS Fasting App Store QR-Code",
  ...
  ja: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting は Apple App Store で公開中です。Google Play は引き続き準備中です。",
      appleStoreBody: "QR コードをスキャンするか、ローカライズされた App Store ページを開いてください。",
      appleStoreAction: "App Store で開く →",
      appleQrAlt: "NoBS Fasting App Store QR コード",
  ...
  hi: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting अब Apple App Store पर live है। Google Play अभी progress में है.",
      appleStoreBody: "QR code scan करें या localized App Store page खोलें.",
      appleStoreAction: "App Store पर खोलें →",
      appleQrAlt: "NoBS Fasting App Store QR Code",
      phasesTitle: "Metabolic Tracking Phases",
  ...
  cn: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting 已在 Apple App Store 上线。Google Play 仍在准备中。",
      appleStoreBody: "扫描二维码，或打开本地化的 App Store 页面。",
      appleStoreAction: "在 App Store 打开 →",
      appleQrAlt: "NoBS Fasting App Store 二维码",
      phasesTitle: "代谢追踪阶段",
  ...
  ko: {
    ...
    fasting: {
      ...
      downloadBody: "NoBS Fasting은 Apple App Store에 출시되었습니다. Google Play는 아직 준비 중입니다.",
      appleStoreBody: "QR 코드를 스캔하거나 현지화된 App Store 페이지를 여세요.",
      appleStoreAction: "App Store에서 열기 →",
      appleQrAlt: "NoBS Fasting App Store QR 코드",
